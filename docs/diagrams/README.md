...
Estos archivos permiten ver los diagramas directamente en GitHub.

GitHub renderiza Mermaid cuando el diagrama esta dentro de un archivo Markdown.
...
- `.md`: vista visual en GitHub usando Mermaid.
