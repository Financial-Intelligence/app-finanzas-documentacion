# App Finanzas - Documentacion

Repositorio de documentacion y arquitectura del sistema financiero.

## Documentos principales

- [Vision general](docs/01_vision_general.md)
- [Modulos](docs/02_modulos.md)
- [Reglas de negocio](docs/03_reglas_negocio.md)
...
- [Modelo conceptual](docs/database/01_modelo_conceptual.md)
- [Modelo logico](docs/database/02_modelo_logico.md)
